...
model_path = 'stable_diffusion_weights/sd_v15_dr/800'             # If you want to use previously trained model saved in gdrive, replace this with the full path of model in gdrive
